...
abstract class ConsoleTextArea extends JTextPane {
    ...
    private void syntaxHighlightInput() {
        ...
        try {
            ...
            SyntaxScheme scheme = SyntaxScheme.loadFromString(SyntaxConstants.SYNTAX_STYLE_PYTHON);
